...
/**
 * Monochrome icons from the MoMorph design, inlined (not `<img>`) so
 * `currentColor` lets each usage site set its own color via `color`/
 * `className="text-*"` — the Figma exports bake `fill="white"`, which an
 * `<img>` tag could never override. See code-rules.md rule 2a.
 */

// mm:I2167:9091;186:1696;186:1821;186:1441 (chevron used by the language menu)
...
// mm:I2167:9091;186:1597;186:1420 (fallback avatar glyph — real avatar image
// takes over once auth is wired up in Track B)
export function IconUserProfile(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="24"
      height="24"
...
// mm:I2167:9063;186:1766 (reused for every "Chi tiết" / CTA trailing arrow —
// same asset hash across all award cards, footer links, and Kudos button)
